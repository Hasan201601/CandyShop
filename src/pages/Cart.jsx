...
import { addToCart, clearCart, decreaseFromCart, getTotals, removeFromCart } from '../redux/CartSlice';
                ...
                <Container className='my-4 align-items-start'>
                    {
                        items.length === 0 ? (
                                ...
                                <Col xs={12} className="border rounded shadow">
                                    ...
                                    <Row className="g-2 align-items-center py-1 my-2 border-4">
                                        ...
                                        <Col xs={3}>
                                            ...
                                            <p onClick={() => handleRemove(item)} className='my-0 text-danger pointer '><small><i className="bi bi-archive"></i> Remove from cart</small></p>
                                        </Col>
                                        <Col xs={3}>
                                            <div className='d-flex align-items-center justify-content-center'>
                                                <button onClick={() => handleDecrease(item)} className='btn btn-danger fs-6 px-2 py-0'>-</button>
                                                <span className='mx-3 fs-3 opacity-75'>{item.cartQuantity}</span>
                                                <button onClick={() => handleIncrease(item)} className='btn btn-danger fs-6 px-2 py-0 ' >+</button>
                                            </div>
                                        </Col>
                                        <Col>
                            ...
                            <div className='d-flex justify-content-between '>
                                <div >
                                    <button onClick={() => dispatch(clearCart())} className='btn btn-outline-danger'> Clear Cart </button>
                                </div>
                                <div >
                                    <div className="continue-shopping">
                                        <h5 className='my-3'>Total : {amount}</h5>
                                        <div className='my-3'>
